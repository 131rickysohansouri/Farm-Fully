...
def fertiforms(request):
    context = {"form": FertilizerForm, "title": 'Fertilizer-Advice'}
...
def addDetails(request):
    ...
    if request.method == "POST":
        try:
            ...
            ferti = FertilizerData(crop=cropname, nitrogen=N,
                                                phosphorous=P, potassium=K)
            ferti.save()

        except:
            context = {"form": FertilizerForm, "title": 'Fertilizer'}
            return render(request, "fertilizer.html", context)
    ...
    fertilizer_dic = {
        'NHigh': """<b>The Nitrogen value of soil is high and might give rise to weeds.</b>
        <br> Please consider the following suggestions:<br/>

        <br/>1. <i>Manure </i> – adding manure is one of the simplest ways to amend your soil with nitrogen. Be careful as there are various types of manures with varying degrees of nitrogen.
        ...
        'Nlow': """<b>The Nitrogen value of your soil is low.</b> 
        <br>Please consider the following suggestions:<br/>

        <br/>1. <i>Add sawdust or fine woodchips to your soil</i> – the carbon in the sawdust/woodchips love nitrogen and will help absorb and soak up and excess nitrogen.
        ...
        'PHigh': """<b>The Phosphorous value of your soil is high.</b>
        <br/> Please consider the following suggestions:<br/>
        ...
        'Plow': """<b>The Phosphorous value of your soil is low.</b>
        <br/> Please consider the following suggestions:<br/>
        ...
        'KHigh': """<b>The Potassium value of your soil is high</b>.
        <br/> Please consider the following suggestions:<br/>
    ...
    print(type(response))
    return render(request, 'fertilizer_result.html', {'recommendation': response, 'title': "Fertilizer-result"})
